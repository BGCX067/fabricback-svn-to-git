...
<div style="margin-top:-20px;"> <!-- Top level div -->
  ...
  <div style="float:left"> <!-- Left level div -->
    ...
    <div style="float:right"> <!-- Right level div -->
        ...
        <table class="box" style="font-size:13px; width:150px;" id="aboveTimeTable">
          <tr nowrap style="font-size:10px;">
            <td>Cust: </td>
            <td>Cust PO: </td>    
            <td>Cust Item: </td>       
            <td>Serial: </td>      
        ...
        <table id="belowTimeTable">
          <tr nowrap>    
            <td nowrap style="font-size:19px; text-align:center"><b>SERVICES: <? echo $service_options; ?></b></td> 
          </tr>
        </table>   


		<table class="boxPrint" style="font-size:12px; width: 5.5in; margin-top:-2px;" id="timeTable">
          <tr>
            <td>&nbsp;</td>
            <td><b>Start</b></td>
            <td><b>Stop</b></td>
