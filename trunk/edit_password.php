...
$cust_username=$_COOKIE["user"];
if($_POST['updatePassBool']){
if ($_POST['password_new']==$_POST['password_retype'] && $_POST['password_old']==mysql_result(mysql_query("SELECT cust_user.PASSWORD FROM cust_user WHERE cust_user.USERNAME='$cust_username'"),0,"PASSWORD") ){
																													   
	$query = "   UPDATE	cust_user SET	cust_user.PASSWORD='$_POST[password_new]' WHERE	cust_user.USERNAME='$cust_username'  ";
...
<html>
  ...
  Your Location:
  <a href="cust_home.php" style="color:#FFF">Customer Home Page </a> ---> Change your password
  </div>
  <!-- /BreadCrumbs -->
